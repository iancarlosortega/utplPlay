...
export class AuthService {
  ...
  agregarRolAdmin(email: string) {
    return this.http.post(`${environment.functionsURL}/api/addAdminRole`, {
      email,
    });
  }

  removerRolAdmin(email: string) {
    return this.http.post(`${environment.functionsURL}/api/removeAdminRole`, {
      email,
    });
  }

  agregarRolEditor(email: string) {
    return this.http.post(`${environment.functionsURL}/api/addEditorRole`, {
      email,
    });
  }

  removerRolEditor(email: string) {
    return this.http.post(`${environment.functionsURL}/api/removeEditorRole`, {
      email,
    });
  }
