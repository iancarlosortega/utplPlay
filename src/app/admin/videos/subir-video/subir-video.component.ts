  ...
  miFormulario: UntypedFormGroup = this.fb.group({
    ...
    url: [
      ...
      [
        ...
        Validators.pattern(this.youtubeLinkRegExp),
      ],
    ],
    career: [, [Validators.required]],
    course: [
      { value: '', disabled: this.materias.length === 0 },
      [Validators.required],
    ],
  });
  ...
  ngOnInit(): void {
    ...
    this.miFormulario
      ...
      ?.valueChanges.pipe(
        ...
        switchMap((carrera) =>
          this.adminService.obtenerMateriasPorCarrera(carrera)
        )
      )
    ...
    this.activatedRoute.params
      .pipe(switchMap(({ id }) => this.adminService.obtenerVideoPorId(id)))
